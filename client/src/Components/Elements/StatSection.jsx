...
const StatsSection = () => {
  return (
    <div className="relative -top-[100px] bg-white rounded-3xl shadow-2xl p-8 w-full max-w-6xl mx-auto mt-10 mb-8 z-1 transition-all duration-700 ease-in-out hover:scale-[1.01]">
