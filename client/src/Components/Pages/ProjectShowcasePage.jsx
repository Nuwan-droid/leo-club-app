...
// Main project images
import image1 from "../../assets/ProjectShowcase/seedforhope.jpg";
import image2 from "../../assets/ProjectShowcase/hope1.jpg";
import image3 from "../../assets/ProjectShowcase/senehase1.jpg";
import image4 from "../../assets/ProjectShowcase/sahasra1.jpg";
import image5 from "../../assets/ProjectShowcase/poddonta_dawasak2.jpg";

// Seeds for Hope project images
import seedsImage1 from "../../assets/ProjectShowcase/seed2.jpg";
import seedsImage2 from "../../assets/ProjectShowcase/seed3.jpg";
import seedsImage3 from "../../assets/ProjectShowcase/seed4.jpg";
import seedsImage4 from "../../assets/ProjectShowcase/seed5.jpg";
 
// Hope for paws project images
import HopeImage1 from "../../assets/ProjectShowcase/hope2.jpg";
import HopeImage2 from "../../assets/ProjectShowcase/hope3.jpg";
import HopeImage3 from "../../assets/ProjectShowcase/hope4.jpg";
import HopeImage4 from "../../assets/ProjectShowcase/hope5.jpg";

// Senehase arunalu project images
import SenehaseImage1 from "../../assets/ProjectShowcase/senehase5.jpg";
import SenehaseImage2 from "../../assets/ProjectShowcase/senehase2.jpg";
import SenehaseImage3 from "../../assets/ProjectShowcase/senehase3.jpg";
import SenehaseImage4 from "../../assets/ProjectShowcase/senehase4.jpg";

// Sahasra images
import SahasraImage1 from "../../assets/ProjectShowcase/sahasra2.jpg";
import SahasraImage2 from "../../assets/ProjectShowcase/sahasra3.jpg";
import SahasraImage3 from "../../assets/ProjectShowcase/sahasra4.jpg";
import SahasraImage4 from "../../assets/ProjectShowcase/sahasra5.jpg";

// Poddonta dawasak images
import PoddontaImage1 from "../../assets/ProjectShowcase/poddonta_dawasak2.jpg";
import PoddontaImage2 from "../../assets/ProjectShowcase/poddonta_dawasak3.jpg";
import PoddontaImage3 from "../../assets/ProjectShowcase/poddonta_dawasak4.jpg";
import PoddontaImage4 from "../../assets/ProjectShowcase/poddonta_dawasak5.jpg";
...
function ProjectShowcasePage() {
  const [projects] = useState([
 {
      ...
      year: "2025",
      image: image1,
      sliderImages: [image1, seedsImage1, seedsImage2, seedsImage3, seedsImage4]
    },
    {
      title: "Hope for Paws",
      ...
      year: "2025",
      image: image2,
      sliderImages: [image2, HopeImage1, HopeImage2, HopeImage3, HopeImage4]
    },
    {
      ...
      year: "2024",
      image: image3,
      sliderImages: [image3, SenehaseImage1, SenehaseImage2, SenehaseImage3, SenehaseImage4]
    },
    {
      ...
      year: "2022",
      image: image4,
      sliderImages: [image4, SahasraImage1, SahasraImage2, SahasraImage3, SahasraImage4]
    },
    {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen font-sans">
      ...
      <ProjectDialog 
        ...
        onClose={closeDialog}
        sliderImages={[image2, image3, image4]}
      />
    </div>
  );
}
